...
using PumpsProjectWebsite.Controllers;
using viewModels = PumpsProjectWebsite.Areas.SecurityGuard.ViewModels;
using PumpsProjectWebsite.Helpers;

namespace PumpsProjectWebsite.Areas.SecurityGuard.Controllers
{
    [OptionalAuthorize(Roles = "SecurityGuard")]
